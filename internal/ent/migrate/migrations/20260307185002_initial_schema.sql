...
-- Create "users" table
CREATE TABLE "users" ("id" uuid NOT NULL, "phone_number" character varying(14) NOT NULL, "email" character varying(255) NOT NULL, "username" character varying(255) NOT NULL, "role" smallint NOT NULL, "state" smallint NOT NULL, "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "password_salt" character varying(36) NOT NULL, "password_hash" character varying(255) NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, PRIMARY KEY ("id"));
