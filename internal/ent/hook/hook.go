...
// function as AccessTokenKey mutator.
type AccessTokenKeyFunc func(context.Context, *ent.AccessTokenKeyMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AccessTokenKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.AccessTokenKeyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AccessTokenKeyMutation", m)
}
