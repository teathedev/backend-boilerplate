...
func (_c *RefreshTokenCreate) SetIsClaimed(v bool) *RefreshTokenCreate {
	_c.mutation.SetIsClaimed(v)
	return _c
}

// SetNillableIsClaimed sets the "is_claimed" field if the given value is not nil.
func (_c *RefreshTokenCreate) SetNillableIsClaimed(v *bool) *RefreshTokenCreate {
	if v != nil {
		_c.SetIsClaimed(*v)
	}
	return _c
...
func (_c *RefreshTokenCreate) defaults() {
	if _, ok := _c.mutation.IsClaimed(); !ok {
...
func (_c *RefreshTokenCreate) createSpec() (*RefreshToken, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.IsClaimed(); ok {
